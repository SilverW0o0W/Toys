...
{
    public class EMCFactory : ItemFactory
    {
        public EMCFactory(Logger log) : base(log)
        {
        }
        ...
        private ItemType GetDocumentType(XmlNode rootNode)
        {
            ItemType type = ItemType.Unknown;
